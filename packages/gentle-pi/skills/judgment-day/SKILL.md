---
name: judgment-day
description: "Trigger: judgment day, dual review, adversarial review, blind dual review, fix confirmed issues, then re-judge."
license: Apache-2.0
metadata:
...
Load this skill only when the user explicitly asks for Judgment Day, dual/adversarial review, or equivalent trigger (`nyay`, `do insaaf`, `faisala`). Review a specific target: files, feature, PR, or architecture slice.
